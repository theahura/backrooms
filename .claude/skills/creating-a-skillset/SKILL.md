...
5. Check the scope. Verify that the ask is good for a skillset.
  ...
  - If too specific, ask me if I want to make a skill instead. If so, use `/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/creating-skills/SKILL.md`.
...
8. If I identified specific subprocesses that should be skills, create those skills using the `/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/creating-skills/SKILL.md` skill.
...
// 'if condition, read and follow  `/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/{skill name}/SKILL.md`'
// 'do abc'
</required>
