...
## Status: Distance-From-Entrance Loot Scaling (Reward Exploration)
...
- All items from the "Next things to build" section are now implemented (more room types, pixel art elements with backrooms flavor, character animations)
