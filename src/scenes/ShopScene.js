...
export class ShopScene extends Phaser.Scene {
  ...
  init(data) {
    ...
    saveGame(shopState, this.registry.get('runCount') ?? 0, this.registry.get('collectedLore') ?? [], this.unlockedLocations, this.activeLocation, this.registry.get('worldSeed') ?? null, this.registry.get('roomState'), this.registry.get('weaponInventory'));
