...
6. Read and follow `/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/building-user-interface-elements/SKILL.md` to properly take the finished design and implement it.
</required>
