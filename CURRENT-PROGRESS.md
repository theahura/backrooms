...
## Status: Per-Enemy-Type Sound Effects
...
- Combat/shooting/battery/inventory/hiding/exploration/startroom/scaling/weapons/lore/pathfinding/danger/roomThemes are pure function modules (`combat.js`, `shooting.js`, `battery.js`, `inventory.js`, `hiding.js`, `exploration.js`, `startroom.js`, `scaling.js`, `weapons.js`, `lore.js`, `pathfinding.js`, `danger.js`, `roomThemes.js`) — same architecture pattern as enemy/movement
...
- Remaining from "Next things to build": light spill from lit rooms through open doors into adjacent dark rooms
