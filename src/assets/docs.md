...
- Each PNG is named exactly after a Phaser texture key (e.g. `player_walk_0.png`, `furniture_couch.png`, `shop_bg.png`, `shop_icon_battery.png`). The key set is driven by `ART_MANIFEST` in `@/src/systems/art.js`
