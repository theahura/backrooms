...
- Read `/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/using-skills/SKILL.md`
...
- Read and follow `/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/using-git-worktrees/SKILL.md` to make sure the worktree is setup (start from step 4).
...
- Conduct research on how to best implement the task.
  - Search for relevant skills using Glob/Grep in `/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/`
...
- Read and follow `/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/writing-plans/SKILL.md`. Write a detailed plan. Do not wait for approval, just keep going after showing me.
...
- Use test driven development. Read and follow `/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/test-driven-development/SKILL.md`.
...
- Update documentation, INCLUDING out of date documentation. Read and follow `/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/updating-noridocs/SKILL.md`
- Write the changes you made to CURRENT-PROGRESS.md.
- Finish development with final checks. Read and follow `/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/finishing-a-development-branch/SKILL.md`
</required>
...
- `/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/systematic-debugging/SKILL.md` - Four-phase debugging framework
- `/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/root-cause-tracing/SKILL.md` - Backward tracing technique
- `/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/creating-debug-tests-and-iterating - Use when debugging some unexpected externally-facing behavior and you do not have stack traces or error logs

# Nori Skills System

You have access to the Nori skills system. Read the full instructions at: /home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/using-skills/SKILL.md

## Available Skills

Found 20 skills:
/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/writing-plans/SKILL.md
  Name: writing-plans
  Description: Use when design is complete and you need detailed implementation tasks for engineers with zero codebase context - creates comprehensive implementation plans with exact file paths, complete code examples, and verification steps assuming engineer has minimal domain knowledge
/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/webapp-testing/SKILL.md
  Name: webapp-testing
  Description: Use this skill to build features or debug anything that uses a webapp frontend.
/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/using-skills/SKILL.md
  Name: using-skills
...
/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/ui-ux-experimentation/SKILL.md
  Name: UI/UX Experimentation
  Description: Use when experimenting with different user interfaces or user experiences.
/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/test-scenario-hygiene/SKILL.md
  Name: test-scenario-hygiene
  Description: Use after TDD is finished, to review and clean the testing additions
/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/test-driven-development/SKILL.md
  Name: test-driven-development
  Description: Use when implementing any feature or bugfix, before writing implementation code - write the test first, watch it fail, write minimal code to pass; ensures tests actually verify behavior by requiring failure first
/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/systematic-debugging/SKILL.md
  Name: systematic-debugging
  Description: Use when encountering any bug, test failure, or unexpected behavior, before proposing fixes - four-phase framework (root cause investigation, pattern analysis, hypothesis testing, implementation) that ensures understanding before attempting solutions
/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/root-cause-tracing/SKILL.md
  Name: root-cause-tracing
  Description: Use when errors occur deep in execution and you need to trace back to find the original trigger - systematically traces bugs backward through call stack, adding instrumentation when needed, to identify source of invalid data or incorrect behavior
/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/receiving-code-review/SKILL.md
  Name: receiving-code-review
  Description: Use when receiving code review feedback, before implementing suggestions, especially if feedback seems unclear or technically questionable - requires technical rigor and verification, not performative agreement or blind implementation
/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/handle-large-tasks/SKILL.md
...
/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/finishing-a-development-branch/SKILL.md
...
/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/creating-skills/SKILL.md
...
/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/creating-debug-tests-and-iterating/SKILL.md
...
/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/creating-a-skillset/SKILL.md
  Name: Creating a Skillset
  Description: Use when asked to create a new skillset.
/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/building-ui-ux/SKILL.md
  Name: building-ui-ux
...
/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/building-agentic-cli-tools/SKILL.md
...
/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/brainstorming/SKILL.md
  Name: brainstorming
...
/home/amol/code/games/backrooms/.worktrees/loop/.claude/skills/nori-info/SKILL.md
  Name: Nori Skillsets
