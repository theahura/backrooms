...
index.html
  -> src/main.js (Phaser.Game config, registers all scenes)
       ...
       |    -> src/systems/distance.js   (BFS hop-distance from entrance over door/stair graph, drives loot + trap + drop scaling)
       ...
       |    -> src/systems/traps.js      (floor trap spawning: spike damage and noise enemy alerts)
